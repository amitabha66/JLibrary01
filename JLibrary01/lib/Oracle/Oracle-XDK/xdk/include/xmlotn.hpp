...
/* DATATYPE DOMExceptionCode - codes for DOM exceptions
    It defines DOM exception codes
*/
...
/* DATATYPE AcceptNodeCodes - values returned by node filters
    Node filters are used by node iterators and tree wlakers
*/
...
/*----------------------------------------------------------------------
    ...
    DOMParser, SAXParser interfaces
...
/* DATATYPE ParserExceptionCode - parser exceptions
    It defines parser exception codes
*/
...
/*---------------------------------------------------------------------
	...
	new_domimpl (IN)
*/
      virtual DocumentRef< Node>* parseDTD( InputSource* src_ptr,
...
/*---------------------------------------------------------------------
	...
	new_domimpl (IN)
*/
      virtual DocumentRef< Node>* parse( InputSource* isrc_ptr,
...
/*---------------------------------------------------------------------
    ...
    DESCRIPTION
        Sets thevalidator for all validations except
...
/*---------------------------------------------------------------------
	...
	the corresponding parameter is not NULL.
	...
	tor_ptr     (IN)
*/
      virtual DocumentRef< Node>* parseSchVal( InputSource* src_par,
					       boolean no_mod = FALSE,
			    DOMImplementation< Node>* impl_ptr = NULL,
...
/*---------------------------------------------------------------------
    ...
    Xsl is the namespace (sub-space of OracleXml) for XSLT
...
/* DATATYPE XslExceptionCode - XSLT related exceptions
    It defines XSLT exception codes
*/
...
/*---------------------------------------------------------------------
	...
	new_domimpl (IN)
*/
      virtual NodeRef< Node>* transform (InputSource* isrc_ptr)
	throw (XslException) = 0;
...
/* DATATYPE XPathExceptionCode - XPath related exception codes
    It defines XPath exception codes
*/
...
*/
      virtual XPathObject< Node>* process (InputSource* isrc_ptr,
				       oratext* xpath_exp)
...
/* DATATYPE FactoryExceptionCode - Tool Factory exceptions
    It defines tool factory exception codes
*/
