// A Sample SAX Handler to handle the events thrown by SAX
// DeCompressor.
...
public class SampleSAXHandler extends DefaultHandler
{
   ...
   static public void main(String[] args) throws SAXException, IOException
   {
      ...
      SampleSAXHandler handler = new SampleSAXHandler();
      handler.init();
      handler.process(args[0]);
   }
   ...
   void process(String filename) throws SAXException, IOException
   {
      ...
      // 2. Nonvalidating, NamespacePrefix = false
